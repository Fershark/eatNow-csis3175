...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static ArrayList<Product> getTripleOProducts() {
        ...
        ArrayList<Product> products = new ArrayList<>();
        products.add(new Product("2-Piece Crispy Fish Burger", "menu_crispy_fish", "Two Ocean Wise crispy beer battered cod fillets, crisp iceberg lettuce, fresh vine-ripened tomatoes, red onion and tartar sauce with our signature pickle on top!", (float) 5.65, restaurantId));
        products.add(new Product("Bacon Cheddar Burger", "menu_bacon_cheddar", "100% fresh Canadian beef, naturally smoked bacon, aged Canadian cheddar, crisp iceberg lettuce, fresh vine-ripened tomatoes, secret Triple O sauce and our signature pickle on top.", (float) 3.95, restaurantId));
        products.add(new Product("Double Double", "menu_double_double", "Not one, but two 100% fresh Canadian beef patties, two slices of cheese, crisp iceberg lettuce, fresh vine-ripened tomatoes, secret Triple O sauce and two signature pickles", (float) 4.05, restaurantId));
        products.add(new Product("Dippin’ Chicken Tenders", "menu_dippin_chicken", "Our 5-piece or 3-piece panko-breaded Dippin' Chicken tenders are made from 100% BC chicken, served your choice of dip. Try them with our signature honey mustard or chipotle mayo!", (float) 6.11, restaurantId));
        products.add(new Product("Chocolate Milkshake", "menu_chocolate_milkshake", "Rich chocolate blended with local Island Farms, premium vanilla bean ice cream, topped with real whipped cream!", (float) 3.55, restaurantId));
        products.add(new Product("Strawberry Milkshake", "menu_strawberry_milkshake", "BC strawberries blended with our local Island Farms, premium vanilla bean ice cream and topped with real whipped cream!", (float) 3.91, restaurantId));
        products.add(new Product("Vanilla Milkshake", "menu_vanilla_milkshake", "Hand-scooped, local Island Farms vanilla bean ice cream, blended then topped with real whipped cream!", (float) 3.51, restaurantId));
    ...
    private static ArrayList<Product> getHyackProducts() {
        ...
        ArrayList<Product> products = new ArrayList<>();
        products.add(new Product("SNAPPER (TAI) NIGIRI", "menu_snapper_nigiri", "Wasabi inside	", (float) 1.35, restaurantId));
        products.add(new Product("COOKED PRAWN (EBI) NIGIRI", "menu_ebi_nigiri", "Wasabi inside", (float) 1.65, restaurantId));
